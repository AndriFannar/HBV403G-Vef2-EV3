import { createCategory, getCategories, getCategory, } from "../db/categories.db.js";
...
export const categoriesApp = new Hono()
    ...
    newCategory = xss(newCategory);
    const validCategory = await CategorySchema.safeParseAsync(newCategory);
    if (!validCategory.success) {
        return c.json({ message: "Invalid data", errors: validCategory.error.flatten() }, 400);
    }
